...
func (r *PostgresRepository) FindOrCreateUser(ctx context.Context, provider, providerSubject, email string) (User, error) {
...
func (r *PostgresRepository) FindActiveMembership(ctx context.Context, userID, organizationID string) (Membership, error) {
	var membershipRecord Membership
