...
class NotificationEventPublisher(
    @Channel("notifications-out") private val queueNotificationEventEmitter: Emitter<NotificationEvent>,
    @Channel("notifications-confirmed-out") private val queueNotificationConfirmedEventEmitter: Emitter<NotificationEvent>
) {
